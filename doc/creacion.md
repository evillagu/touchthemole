...
## 7) Ajuste de versiones (Angular y TypeScript)

- Se bajó Angular a `19.1.0` y TypeScript a `5.7.0`.
- Motivo: TypeScript `5.7.0` solo es compatible con Angular `19.1.x`, por eso se ajustaron las versiones.
