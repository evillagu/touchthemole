  ...
  describe('save', () => {
    const saveTestCases = [
      ...
      { playerName: 'Player2', points: 100, description: 'state with points' },
      {
        ...
        points: 500,
        description: 'state with spaces in name',
      },
    ];

    describe('save different states', () => {
  ...
  describe('load', () => {
    ...
    describe('load invalid states', () => {
      const invalidStateTestCases = [
        ...
        {
          state: { playerName: 'Test', points: 'invalid' },
          description: 'invalid points type',
        },
        {
          state: { playerName: 'Test', points: 100 },
